...
from utils.model_util import extract_error_counts, calculate_mqm_score
...
def evaluate_translation_with_gpt(source_text: str, 
    ...
    """GPT 모델을 사용하여 번역을 평가하고 MQM 점수 추출"""
...
# python gpt4o_few_shot.py --data_path data/03_03_Createll_241111_firsttrans_eval_he.csv --prompt_path prompts/few_shot_prompt.yaml
# python gpt4o_few_shot.py --data_path data/03_03_Createll_241111_firsttrans_eval_he.csv --model gpt-4.1 --prompt_path prompts/few_shot_prompt.yaml --output_dir results/gpt4.1
